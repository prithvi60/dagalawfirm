...
export const ContactDetailsAddress = ({ data1, data2, title1, title2 }) => {
    return (
        <section className={`flex flex-col md:flex-row h-full border-2 border-info relative font-merriWeather`}>
            ...
            <div className={`grid-cols-2 grid place-content-center place-items-center  gap-5 w-full py-8 md:py-5 basis-3/5 px-5 "}`}>
                <div className='flex flex-col items-center justify-center gap-5'>
