...
export const ContactDetailsAddress = ({ title1, title2 }) => {
    return (
        <section className={`flex flex-col-reverse md:flex-row h-full border-2 border-copy relative font-merriWeather`}>
            ...
            <div className={`grid-cols-1 sm:grid-cols-2 md:hidden grid md:place-content-center md:place-items-center gap-5 w-full py-8 md:py-5 px-5 "}`}>
