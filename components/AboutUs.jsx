        ...
        <section className="w-full h-full px-5 border-t-2 border-copy font-merriWeather">
            ...
            >
                <motion.div
                    ...
                    initial="initial"
                    whileInView="animate"
                    className="relative z-0 w-full h-72 md:w-[500px] md:h-[500px]"
                >
                    <Image
                        alt="bg image"
                        src={"/sample-6.jpg"}
                ...
                <motion.ul
                    ...
                    initial="initial"
                    whileInView="animate"
                    className="relative w-full mx-auto space-y-5 text-base font-normal md:w-3/4 md:text-lg text-justify font-merriWeather !leading-[32px]"
                >
                    ...
                    <li>
                        ...
                        Madras High Court,the Delhi High Court,the Intellectual Property
                        Rights Tribunal, and several other legal bodies. Its vast expertise
                        ...
                        Singapore etc., providing a comprehensive global outreach. It has
                        successfully represented clients from multiple industries, such as
                        technology, pharmaceuticals, fashion, media and entertainment, among
                        others.
                    </li>
                    <li>
                        The firm takes pride in staying ahead of the curve in the
                        ever-evolving legal landscape ensuring that its clients&apos;
                        interests are protected at all times. End-to-end support is ensured
                        at every stage of the journey from filing applications to defending
