...
const PracticesComponent = () => {
    return (
        <>
            <h2 className="flex justify-center px-5 text-xl font-medium tracking-wide capitalize py-7 lg:px-16 lg:py-12 md:text-3xl text-copy font-merriWeather">Practice areas where we excel</h2>
            <section className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3'>
                {services.map((item, idx) => (
                    <div key={idx} className={`font-merriWeather flex flex-col md:flex-row justify-center items-center h-full border-2 border-copy relative py-10`}>
