...
export const PersonDescription = ({ data }) => {
    return (
        <section className="relative flex flex-col gap-5 px-5 border-t-2 mt-14 md:mt-16 md:flex-row lg:pl-16 border-info font-merriWeather py-7 lg:px-16 lg:py-12 md:gap-0">
            <div className='basis-full md:basis-2/5'>
                <div className="relative w-full h-[340px] md:size-[360px] lg:size-[450px] overflow-hidden group z-0 contrast-100  md:sticky md:top-32">
                    <Image alt="sample-image" src={data.img} fill className="object-contain object-center transition-all duration-200 ease-in-out group-hover:scale-110" />
