...
const Team = () => {
    return (
        <section className="flex flex-col py-7 lg:py-12 md:flex-row">
            <div className="relative w-full md:h-[520px] h-[380px] overflow-hidden group z-0 contrast-100">
                ...
                <div className="absolute left-0 z-10 flex items-center justify-between w-full px-5 bottom-10 lg:px-8">
                    ...
                    <Link href={""} className="p-1 transition-all duration-200 ease-in-out rounded-full bg-secondary w-max group-hover:scale-110 group-hover:animate-bounce">
