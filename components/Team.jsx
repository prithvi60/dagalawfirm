...
const Team = () => {
    return (
        <section className="flex flex-col items-center justify-center gap-5 md:gap-8 py-7 lg:py-12 md:flex-row font-merriWeather">
            <Link href={"/team/founder"} className="relative w-[320px] md:w-[460px] md:h-[620px] h-[440px] overflow-hidden group z-0 contrast-100 bg-white border-2 border-copy">
            ...
            <Link href={"/team/litigations"} className="relative w-[320px] md:w-[460px] md:h-[620px] h-[440px] overflow-hidden group z-0 contrast-100 bg-white border-2 border-copy">
