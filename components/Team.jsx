...
const Team = () => {
    return (
        <section className="flex flex-col items-center justify-center gap-5 md:gap-8 py-7 lg:py-12 md:flex-row font-merriWeather">
            <Link href={"/team/founder"} className="relative w-[220px] md:w-[360px] md:h-[520px] h-[340px] overflow-hidden group z-0 contrast-100 bg-white border-2 border-copy">
            ...
            <Link href={"/team/litigations"} className="relative w-[220px] md:w-[360px] md:h-[520px] h-[340px] overflow-hidden group z-0 contrast-100 bg-white border-2 border-copy">
                ...
                <div className="absolute bottom-0 left-0 z-10 flex items-center justify-center gap-6 xl:gap-16 w-full py-2 px-5 lg:px-8 backdrop-brightness-[0.60]">
                    <div className="block">
                        <h3 className="mb-4 text-lg font-medium text-white md:text-xl font-merriWeather">Mr. A. Jayesh Kumar Daga</h3>
