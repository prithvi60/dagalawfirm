        ...
        <section className="font-merriWeather relative flex flex-col md:flex-row w-full h-full md:h-[65vh] xl:h-[75vh] overflow-hidden mt-14">
            ...
            <div className="h-full basis-full md:basis-2/5">
                <motion.div
                    ...
                    <h1 className='font-bold tracking-wide capitalize text-2xl lg:text-4xl xl:text-[48px] font-merriWeather text-info leading-9 lg:!leading-[42px]'>Your Guide to Law: Expert Articles & Advice</h1>
