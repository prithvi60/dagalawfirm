...
const EventLaw = ({ mainTitle, title, img, bgImg, data, styles }) => {
  return (
    <section className="w-full h-full space-y-4 overflow-hidden border border-copy font-merriWeather">
      <motion.div
        variants={variantTitle}
        viewport={{ amount: 0.3, once: true }}
        initial="initial"
        whileInView="animate"
        className="flex flex-col items-center justify-center gap-1 my-8 lg:items-start lg:flex-row text-info"
      >
      ...
      <div
        className={`${styles} h-full gap-10 mb-5 px-5 pb-6 md:gap-6 lg:px-16 lg:pb-8`}
      >
        <motion.div
          variants={variant1}
          viewport={{ amount: 0.3, once: true }}
          initial="initial"
          whileInView="animate"
          className="relative z-0 w-full h-72 md:w-[400px] md:h-[400px]"
        >
          <Image
            alt="bg image"
            src={img}
        ...
        <motion.div
          ...
          initial="initial"
          whileInView="animate"
          className="w-full md:px-5 sm:px-0 "
        >
