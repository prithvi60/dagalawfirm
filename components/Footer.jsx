...
const Footer = () => {
  return (
    <footer className="flex flex-col items-center justify-between gap-4 p-5 border-t-2 sm:items-start font-merriWeather lg:gap-10 md:mt-0 sm:flex-row lg:px-16 lg:py-8 border-copy">
      ...
      <div
        className={
          "w-48 lg:w-56 h-10 md:h-16 relative overflow-hidden order-1 md:order-2"
        }
      >
        <Image
          alt="daga logo"
      ...
      <div className="flex flex-row items-center order-3 gap-2 text-sm font-medium md:flex-col lg:gap-2 md:text-base font-merriWeather">
        <Link
          href="https://www.linkedin.com/company/daga-daga"
          className="hover:animate-pulse"
          target="blank"
        >
          <FaLinkedin className="text-2xl md:text-4xl text-accent" />
        </Link>
